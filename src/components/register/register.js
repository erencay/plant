    ...
    .then((providers) => {
      ...
      if (user) {
        ...
        render(){
          ...
          const sayi = '/'
          if(this.state.redirect === 'login'){            this.direct = () => {
              ...
              <div className="login-page">
                ...
                <div className="form">
                  <form className="login-form">
                    <input type="text" placeholder="Kullanıcı Adı" ref={(input) =>
                        {
                          this.usernameInput = input
                        }}/>
                    <input type="password" placeholder="Şifre" ref={(input) =>
                        {
                          this.passwordInput = input
                        }}/>
                    <input type="email" placeholder="E-mail" ref={(input) =>
                        {
                          this.emailInput = input
                        }}/>
                      <button onClick={(event) =>
                        {this.registerWithPassword(event)}} >kayıt ol
                      </button>

                      <p className='direct-login'>KAYITLI İSEN</p>

                      <Link to='/'>
                          <button className='direct-login-button'>
                            Giriş yap
                          </button>
                      </Link>
